...
public class MainActivity extends AppCompatActivity /*FragmentActivity implements ConnectionCallbacks, OnConnectionFailedListener, View.OnClickListener */{
...
//                    .addScope(new RestrictTo.Scope("email"))
//                    .build();
//        }
//
//
